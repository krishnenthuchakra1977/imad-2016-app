...
app.get('/ui/css/animate.css', function (req, res) {
...
app.get('/ui/js/jquery.cbpFWSlider.min.js', function (req, res) {
...
app.get('/ui/js/modernizr.custom.js', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'modernizr.custom.js'));
});

app.get('/ui/js/owl.carousel.js', function (req, res) {
